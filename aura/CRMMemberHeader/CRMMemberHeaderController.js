({
    ...
    refreshFromSystemOfRecord: function (component, event, helper) {
        ...
        refreshContactAction.setCallback(this, function (response) {
            ...
            if (component.isValid() && state === 'SUCCESS') {
                ...
                if (!contact) {
                    // This message is now being handled by the login at the top of the page.
    ...
    saveChanges: function (component, event, helper) {
        ...
        if (!verifiedIdentity) {
            component.set('v.errorMessageEdit', 'Verification of identification must be completed for all changes of address requested by phone.  Verification is completed by obtaining correct answers to no less than 2 identifying questions and 1 out of wallet question.  Please check the box below to indicate that you have followed this procedure.');
            return;
        }
