({
    ...
    doInit: function (component, event, helper) {
        ...
        // Disabling for now due to coronavirus.
    ...
    getHeaderInfo: function (component, event, helper) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                // Redact the SSN
                if (values.contact.TaxID__c) {
                    helper.redactSocial(component, values.contact.TaxID__c);
                }
    ...
    hideSocial: function (component) {
        component.set("v.viewingSocial", false);
    },
    ...
    refreshFromSystemOfRecord: function (component, event, helper) {
        ...
        refreshContactAction.setCallback(this, function (response) {
            ...
            if (component.isValid() && state === 'SUCCESS') {
                ...
                //redact social
                if (contact.TaxID__c) {
                    helper.redactSocial(component, contact.TaxID__c);
                }
    ...
    showSocial: function (component) {
        component.set("v.viewingSocial", true);
    },
